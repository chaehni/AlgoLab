...
| PotW 2 (2018) | Magician and the Coin           | 100    | recursion & memoization                                                                                           |
| PotW 2 (2019) | From Russia with Love           | 100    | recursion & memoization                                                                                           |
...
| PotW 3        | Defensive Line                  | 100    | sliding window & DP                                                                                               |
...
| PotW 4        | Hiking Maps                     | 100    | inclusion test & sliding window                                                                                   |
...
| PotW 5        | Planet Express                  | 100    | strong components & Dijkstra                                                                                      |
...
| PotW 6        | Octopussy                       | 100    | greedy with recursive dependency resolution                                                                       |
...
| PotW 7        | London                          | 100    | max flow, edges between front/back letter combinations                                                            |
...
| PotW 8        | Suez                            | 100    | find constraints/objective and solve with LP                                                                      |
...
| PotW 9       | GoldenEye                       | 100    | voronoi (using Delauny) & union find                                                                              |
| 10            | New Tiles                       | ---    |                                                                                                                   |
...
| PotW 10       | India                           | 100    | min cost max flow, binary search on number of suitcases to find maximum that still respects budget (see Marathon) |
...
| PotW 11       | New York                        | 100    | DFS over all trees, for every node discovered update node m hops above                                            |
...
| PotW 12       | World Cup (mock exam)           | 100    | Delauny to find relevant contour lines & LP to maximize profit under constraints                                  |
...
| PotW 13       | Fleetrace                       | 100    | minimum cost bipartite matching                                                                                   |
